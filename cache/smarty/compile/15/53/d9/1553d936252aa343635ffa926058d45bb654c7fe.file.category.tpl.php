<?php /* Smarty version Smarty-3.1.19, created on 2016-01-11 12:29:42
         compiled from "/home/ac3gam3r/public_html/themes/default-bootstrap/category.tpl" */ ?>
<?php /*%%SmartyHeaderCode:498382026569352de3bb4c1-35022772%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1553d936252aa343635ffa926058d45bb654c7fe' => 
    array (
      0 => '/home/ac3gam3r/public_html/themes/default-bootstrap/category.tpl',
      1 => 1452491863,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '498382026569352de3bb4c1-35022772',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_569352de6de365_01287024',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_569352de6de365_01287024')) {function content_569352de6de365_01287024($_smarty_tpl) {?>
...
<?php }?></span><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./category-count.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
		...
		<div id="subcategories">
			<p class="subcategory-heading"><?php echo smartyTranslate(array('s'=>'Shops'),$_smarty_tpl);?>
</p>
			<ul class="clearfix">
...
"><?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['subcategory']->value['name'],25,'...'), ENT_QUOTES, 'UTF-8', true);?>
        ...
        <?php }?>
		<?php }?>
	<?php if (isset($_smarty_tpl->tpl_vars['subcategoriestype']->value)) {?>
			<?php if ((isset($_smarty_tpl->tpl_vars['display_subcategories']->value)&&$_smarty_tpl->tpl_vars['display_subcategories']->value==1)||!isset($_smarty_tpl->tpl_vars['display_subcategories']->value)) {?>
				<!-- SubcategoriesType -->
				<div id="subcategories">
					<p class="subcategory-heading"><?php echo smartyTranslate(array('s'=>'Categories'),$_smarty_tpl);?>
</p>
					<ul class="clearfix">
						<?php  $_smarty_tpl->tpl_vars['subcategory'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['subcategory']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['subcategoriestype']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['subcategory']->key => $_smarty_tpl->tpl_vars['subcategory']->value) {
$_smarty_tpl->tpl_vars['subcategory']->_loop = true;
?>
							<li>
