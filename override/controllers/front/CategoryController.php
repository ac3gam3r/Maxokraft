...
class CategoryController extends FrontController
{
	...
	protected function assignSubcategories()
	{
	    ...
	    /**
     * Assigns subcategory type templates variables
     */
    protected function assignSubcategoriesType()
    {
        if ($sub_categories = $this->category->getSubCategoriesType($this->context->language->id)) {
            $this->context->smarty->assign(array(
                'subcategoriestype'      => $sub_categories,
