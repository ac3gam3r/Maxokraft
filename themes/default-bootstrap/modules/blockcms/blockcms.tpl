...
{else}
	...
	<section class="footer-block col-xs-12 col-sm-2" id="block_various_links_footer">
		<h4>{l s='About us' mod='blockcms'}</h4>
	...
	<section class="footer-block col-xs-12 col-sm-2" id="block_various_links_footer">
		<h4>{l s='Quick find' mod='blockcms'}</h4>
		<ul class="toggle-footer">
	...
	<section class="bottom-footer col-xs-12">
		<div>
			&copy;2015 {l s='Maxokraft Group, Inc. All rights reserved.' mod='blockcms' tags=['<a class="_blank" href="http://www.maxokraft.com">']}
		</div>
	</section>
	{/if}
	<!-- /MODULE Block footer -->
