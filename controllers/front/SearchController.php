...
class SearchControllerCore extends FrontController
{
	...
	public function initContent()
	{
		...
		if ($this->ajax_search)
		{
			...
			$searchResults1 = Search::findcategory((int)(Tools::getValue('id_lang')), $query);
			if (is_array($searchResults1)){
				foreach ($searchResults1 as &$product1){
					$product1['product_link'] = $product1['id_category'] . "-" . $product1['crewrite'];
				}
			}
			...
			$this->ajaxDie(Tools::jsonEncode($searchResults1));
		}
